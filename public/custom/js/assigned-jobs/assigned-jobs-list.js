    ...
    */
    function loadDatatables(){
        ...
        var table = tableId.DataTable({
            ...
            serverSide: true,
            method:'get',
            ajax: baseURL + '/assigned-jobs/datatable-list',
            columns: [
                ...
                {data: "job_code", name: "job_code"},
                {
                    ...
                    render: function (data, type, row) {
                        return (data!=null) ? data + '<br>' + (row.start_time!=null)? row.start_time:'' : ''; // Combine date and time
                    }
                },
                {
                    data: "end_date",
                    name: "end_date",
                    render: function (data, type, row) {
                        return (data!=null) ? data + '<br>' + row.end_time : ''; // Combine date and time
                    }
                },
