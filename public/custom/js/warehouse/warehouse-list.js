    ...
    function loadDatatables(){
        ...
        var table = tableId.DataTable({
            ...
            columns: [
                ...
                {data: 'worth_cost', name: 'worth_cost', className: 'text-end'},

                {data: 'worth_sale_price', name: 'worth_sale_price', className: 'text-end'},

                {data: 'worth_profit', name: 'worth_profit', className: 'text-end'},
