    ...
    */
    function loadDatatables(){
        ...
        var table = tableId.DataTable({
            ...
            serverSide: true,
            method:'get',
            ajax: baseURL+'/currency/datatable-list',
            columns: [
...

                {
                    ...
                    name: 'name',
                      render: function(data, type, row) {
                          ...
                          if(row.is_company_currency == 1){

                            return '<span>' + data + '</span><br><div class="badge text-primary bg-light-primary text-uppercase p-1">(Company Currency)</div>';
