$(function() {
    ...
    let openModal = $('#expenseSubcategoryModal');

    let categorySelectionBox = $('select[name="expense_subcategory_id"]')

    $("#expenseSubcategoryForm").on("submit", function(e) {
        e.preventDefault();
        const form = $(this);
        const formArray = {
            formId: form.attr("id"),
    ...
    function closeModalAndAddOption(response){
        ...
        categorySelectionBox.append(newOption);
        categorySelectionBox.trigger('change');
    }
});//main function
