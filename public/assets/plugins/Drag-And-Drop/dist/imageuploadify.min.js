...
(function($, window, document, undefined) {
	window.addEventListener("dragover", function(e) {
		if(!custom_imageuploadify(totalFiles.length)){
			return false;
		}
		e = e || event;
		e.preventDefault();
	...
	$.fn.imageuploadify = function(opts) {
		...
		this.each(function() {
			...
			let totalFiles = [];
			let counter = 0;
			let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-images-list text-center"><button type="button"class="btn btn-default">Select file to upload</button></div></div>`);
...
function custom_imageuploadify(total_files = 0){

	//where 0 mean one file upload limit
	var image_upload_limit = 1;
	
	if(total_files == image_upload_limit){
		var message = "You cannot upload more than " + image_upload_limit + " image";
