    ...
    window.loadDatatables = function() {
        ...
        var table = tableId.DataTable({
            ...
            columns: [
                ...
                {
                    data: null, // Combine return_code and status in this column
                    name: 'return_code',
                    orderable: false,
                    className: 'text-center',
                    render: function(data, type, full, meta) {
                        ...
                        let orderCode = data.return_code || ''; // Default if return_code is null
                        let statusUrl = data.status?.url || '';
                        let statusBadge = '';

                        if (data.status?.text === 'From Purchase Bill') {
